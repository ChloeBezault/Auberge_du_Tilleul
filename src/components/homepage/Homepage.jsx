        ...
        <main className="homepage">
            <section className="welcome-carrosel">
                <figure className="imgs-carrousel">
                    <img srcset="/images/Images-Carrousel/ImgCarrousel-1.jpg 640w" src="/images/Images-Carrousel/ImgCarrousel-1.jpg" alt="Img-restaurant" className="Imgages-carrousel" width={"1800"} height={"900"}/>
            ...
            <section className="presentation-halls">
                ...
                <div className="Cards">
                    <ul>
                        <li>
                            <img src="/images/Img-Cards/Card1.jpg" alt="" className="Monet-hall"/>
                            <h3>Salon Monet</h3>
                        </li>
                        <li>
                            <img src="/images/Img-Cards/Card2.jpg" alt="" className="Picasso-hall"/>
                            <h3>Salon Picasso</h3>
                        </li>
                        <li>
                            <img src="/images/Img-Cards/Card3.jpg" alt="" className="Gauguin-hall"/>
                            <h3>Salon Gauguin</h3>
                        </li>  
                    </ul>
                </div>
            ...
            <section className="customers-feedback">
                ...
                <div className="brands">
                    ...
                    <img srcset="" src="" alt="" className="brands-carrousel" />
                </div>
